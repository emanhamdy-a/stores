      ...
      <div id="box-currency" class="box-content d-flex">
        <div class="w-100">
          ...
          <div class="item-currency">
            <a title="US Dollar" rel="nofollow" href="index-2.htm?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">US
              Dollar: USD</a>
          </div>
        </div>
      </div>
        ...
        <div class="w-100">
          <div class="item-language current">
            <a href="index.htm?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2"
                src="../img/l/1.jpg" alt="English (English)" width="16" height="11"><span>English</span></a>
          </div>
          <div class="item-language">
            <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3"
              class="d-flex align-items-center"><img class="img-fluid mr-2" src="../img/l/2.jpg" alt="Français (French)"
                width="16" height="11"><span>Français</span></a>
          </div>
          <div class="item-language">
            <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3"
              class="d-flex align-items-center"><img class="img-fluid mr-2" src="../img/l/3.jpg" alt="Español (Spanish)"
                width="16" height="11"><span>Español</span></a>
          </div>
          <div class="item-language">
          ...
          <div class="item-language">
            <a href="http://demo.bestprestashoptheme.com/savemart/pl/?home=home_3"
              class="d-flex align-items-center"><img class="img-fluid mr-2" src="../img/l/5.jpg" alt="Polski (Polish)"
                width="16" height="11"><span>Polski</span></a>
          </div>
          <div class="item-language">
