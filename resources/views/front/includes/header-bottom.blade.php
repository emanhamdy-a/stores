                    ...
                    <div class="dropdown-menu" style="width:222px">
                      <ul>
                        ...
                        <li class="item  parent">
                          <a href="category',$childern -> slug )}}" title="Laptop Thinkpad">{{$childern -> name}}</a>
                          ...
                          <div class="dropdown-menu">
                            <ul>
                              ...
                              <li class="item ">
                                <a href="category',$_childern -> slug )}}" title="Aliquam lobortis">
                                  {{$_childern -> name}}
                                </a>
                              </li>
                              @endforeach
              ...
              <div id="megamenu" class="nov-megamenu clearfix">
                <ul class="menu level1">
                  ...
                  <li class="item menu-page group">
                    <span class="opener"></span>
                    <a href="sitemap.html? controller=sitemap" title="Pages"><i class="zmdi zmdi-assignment"></i>Pages
                    </a>
                    <div class="dropdown-menu">
                      <ul class="">
                          ...
                          <div class="dropdown-menu">
                            <ul class="">
                              ...
                              <li class="item col-md-3 mw-40 html">
                                <div class="menu-content">
                                  <div class="menu-banner-3 text-center"><a href="#">
                                      <img class="img-fluid" src="img/mega-menu-3.jpg" alt="mega-menu-3.jpg"></a>
                                  </div>
                                </div>
                              </li>
                            </ul>
                                ...
                                <div class="menu-content">
                                  <div class="row">
                                    <div class="col-12 col-lg-4 col-md-4 mt-xs-10 text-center">
                                      <a href="#"><img class="img-fluid" src="img/banner-mega-1.jpg"
                                          alt="menu-banner-1"></a>
                                    </div>
                                    <div class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                      <a href="#"><img class="img-fluid" src="img/banner-mega-2.jpg"
                                          alt="menu-banner-2"></a>
                                    </div>
                                    <div class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                      <a href="#"><img class="img-fluid" src="img/banner-mega-3.jpg"
                                          alt="menu-banner-3"></a>
                                    </div>
                                  </div>
                                </div>
