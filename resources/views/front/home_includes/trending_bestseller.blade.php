    ...
    <div class="nov-productlist productlist-slider col-xl-9 col-lg-9 col-md-9 col-xs-12 col-md-12">
      <div class="block block-product clearfix">
        ...
        <div class="block_content">
          <div id="productlist895890" class="product_list grid owl-carousel owl-theme multi-row"
            data-autoplay="false" data-autoplaytimeout="9000" data-loop="false" data-margin="10" data-dots="false"
            data-nav="true" data-items="3" data-items_large="3" data-items_tablet="3" data-items_mobile="2">
            @if($trendes)
              <?php $i=0 ?>
              ...
              <div class="item  text-center">
                @foreach($bestSellers as $product)
                  <div class="d-flex flex-wrap align-items-start
                    product-miniature js-product-miniature  first_item"
                    data-id-product="{{ $product->id }}" data-id-product-attribute="40" itemscope="" itemtype="http://schema.org/Product">
